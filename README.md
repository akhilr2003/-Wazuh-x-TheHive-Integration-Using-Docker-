...
Welcome to  **SOC Lab Project** — a hands-on guide to building your own **SIEM + Incident Response automation setup** using **Wazuh** and **TheHive** inside **Ubuntu** 🐧.  
...
Use this only in a local or test environment

Don’t expose TheHive or Wazuh ports to the public
...
🔍Cybersecurity Engineer | EC-Council Certified SOC Analyst🛡️
💬 “Every log tells a story — listen carefully, and you’ll find the intruder.” 👾

🧩 Connect & Contribute

If you liked this project, ⭐ it on GitHub!
Pull requests, issues, or cyber memes are always welcome 😁
